...
import com.example.mdxj.view.BookView;
import com.example.mdxj.view.SunMoonView;
import com.example.mdxj.view.ThirdScreenView;
...
public class WelcomeActivity extends FragmentActivity {
    ...
    public void date() {
        ...
        if (isfer) {
            ...
            //第二次进入跳转
            Intent in = new Intent(WelcomeActivity.this, WelcomeTwoActivity.class);
            startActivity(in);
            finish();
    ...
    private class ScreenSlidePagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            ScreenSlideFragment fragment = new ScreenSlideFragment(WelcomeActivity.this);
